...
set -o pipefail && xcodebuild -project "Carthage Project/RxUtils.xcodeproj" -sdk iphonesimulator -target "Example" | xcpretty
...
set -o pipefail && xcodebuild -project "Carthage Project/RxUtils.xcodeproj" -sdk iphonesimulator -scheme "Example" -destination "platform=iOS Simulator,id=${simulator_id}" test | xcpretty
